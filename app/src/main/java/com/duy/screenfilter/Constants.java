...
public class Constants {
     ...
     * Service
     */
    public static final String EXTRA_ACTION = "action", EXTRA_BRIGHTNESS = "brightness", EXTRA_MODE = "mode", EXTRA_CHECK_FROM_TOGGLE = "check_from_toggle", EXTRA_DO_NOT_SEND_CHECK = "dont_send_check";
